	...
	<div class="container py-4">
		...
		<div id="output" hidden class="mt-4">
			<div class="row g-4">
				...
				<div class="col-lg-5">
					<!-- Preview Dokumen -->
					<div class="card shadow-sm mb-3" id="previewCard" hidden>
						<div class="card-header bg-white fw-bold">Preview Dokumen</div>
						<div class="card-body text-center p-2 bg-light rounded-bottom">
							<img id="imagePreview" src="" alt="Preview" class="img-fluid rounded" style="max-height: 400px; object-fit: contain;" hidden>
							<div id="pdfPreview" class="py-5" hidden>
								<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#e74c3c" viewBox="0 0 16 16">
									<path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z"/>
								</svg>
								<p class="mt-2 mb-0 fw-bold">Dokumen PDF Terpilih</p>
							</div>
						</div>
					</div>
